...
public class DialogTest : MonoBehaviour
{
    ...
    private int index;
    private PlayerInputActions playerInputActionsEE;
    ...
    void Start()
    {
       ...
       // playerInputActionsEE = playerMovement.playerInputActions;
    }
    void Update()
    {
    ...
    public void startDialog()
    {
        ...
        //playerInputActionsEE.Player.Disable();
    ...
    void NextLine()
    {
        ...
        else
        {
            ...
            gameObject.SetActive(false);
          // playerInputActionsEE.Player.Enable();
        }
    }
